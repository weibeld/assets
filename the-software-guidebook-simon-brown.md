---
source: https://leanpub.com/documenting-software-architecture
notes: One-to-one copy of sections 3 to 15 of _The software guidebook_ (with removed section numbers). The specific version of the book used as a source is 2022-05-28.
---
...
By all means refer to existing documentation if it's available; and by this I mean functional specifications, use case documents or even lists of user stories. However, it's often useful to summarise the business domain and the functionality provided by the system. Again, diagrams can help, and you could use a UML use case diagram or a collection of simple wireframes showing the important parts of the user interface. Either way, remember that the purpose of this section is to provide an overview.
